...
@section('content')
	<h1 class="page-heading">Prepara a DMCA Notice</h1>
	...
	{!! Form::open(['method' => 'GET', 'action' => 'NoticesController@confirm']) !!}
		...
		<div class="form-group">
			{!! Form::label('original_link', 'To verify you can own the content, we now need the link to the original content on your server')!!}
			{!! Form::text('original_link', null, ['class' => 'form-control']) !!}
		</div>

		<div class="form-group">
			{!! Form::label('original_description', 'And, finally, it might help to provide some extra information related to the DMCA notice')!!}
